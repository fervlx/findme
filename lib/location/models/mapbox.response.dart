...
MapboxResponse mapboxResponseFromJson(String str) => MapboxResponse.fromJson(json.decode(str));

String mapboxResponseToJson(MapboxResponse data) => json.encode(data.toJson());
